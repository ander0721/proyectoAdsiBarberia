		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="{{route('register')}}" method="POST">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text"name="rol" id="rol" placeholder="Nombres de usuario">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<img src="https://img.icons8.com/ios/16/000000/user-male-circle.png" aria-hidden="true"/>
						</span>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Password is required" >
						<input class="input100" type="password" name="password_confirmation" id="password-confirm" required autocomplete="new-password"placeholder="Contraseña">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<img src="https://img.icons8.com/ios/16/000000/password--v1.png" aria-hidden="true"/>
						</span>
