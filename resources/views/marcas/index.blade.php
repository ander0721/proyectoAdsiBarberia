                    ...
                    <div class="modal-body">
                        <form id="ItemForm" name="ItemForm" class="form-horizontal">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-md-12">
                                <input id="nombreM" name="nombreM" type="text" placeholder="Ingrese la marca" class="form-control input-md">
                                    </div>
                                </div>
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $('#createNewItem').click(function () {
        $('#saveBtn').val("crear marca");
        $('#marca_id').val('');
        $('#ItemForm').trigger("reset");
        $('#modelHeading').html("Crear marca");
    ...
    $.ajaxSetup({
      ...
      $.get("{{ route('marca.index') }}" +'/' + marca_id +'/edit', function (data) {
          $('#modelHeading').html("Editar marca");
          $('#saveBtn').val("edit-user");
          $('#ajaxModel').modal('show');
          $('#marca_id').val(data.idM);
    ...
    $('body').on('click', '.deleteItem', function () {
        ...
        $.ajax({
            type: "DELETE",
            url: "{{ route('marca.store') }}"+'/'+marca_id,
            success: function (data) {
                table.draw();
            },
            error: function (data) {
